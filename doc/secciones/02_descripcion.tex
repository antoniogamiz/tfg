...
\begin{enumerate}
      ...
      \item \label{obj:2} Crear la base teórica, a partir de la de Word2Vec, para poder usar el algoritmo con conjuntos de tropos (más generalmente, conjuntos sin orden)
\end{enumerate}
