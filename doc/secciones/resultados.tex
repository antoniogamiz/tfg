...
\begin{itemize}
  ...
  \item \textit{ArcWords}: representa alguna frase simbóliga que aprece reiteradas veces a lo largo de un arco argumental.
...
que futurus investigadores o personas interesadas pueden continuar el trabajo con los tropos o incluso aplicar el modelo a otro tipo de datos, como recetas \cite{kazama2018neural}.